...
/*                                                   +#+                      */
/*   Created: 2025/01/20 10:32:33 by mmoser        #+#    #+#                 */
/*   Updated: 2025/01/20 10:33:35 by mmoser        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "../../cub3d.h"

static u_int32_t	get_scaled_height(double wall_distance,
		size_t plane_distance)
{
...
t_error	draw_view(t_cub3d *cub3d)
{
	...
	{
		find_distance_to_wall(&ray, cub3d->player_pos, cub3d->view.dir_angle,
			&cub3d->map);
		scaled_height = get_scaled_height(ray.actual_distance,
				cub3d->view.plane_distance);
